...
To run it, you just need to change a couple of paths in the _feature_extraction_ function and the path to the features in the
[metadata file](https://github.com/neomoha/music-autotagging-msordo/blob/master/metadata/majorminer_metadata.tsv).
